...
class LoopPlayer {
  ...
  // Стингер: одиночный звук на моменте перехода (имя — из целевой части)
  ...
  _tick() {
    ...
    while (this.nextTime - now < this.LOOKAHEAD) {
      ...
      if (isSectionChange) {
        ...
        // стингер целевой части: звук на входе в неё
...
function Waveform({
  ...
  const draw = useCallback(() => {
    ...
    segments.forEach((s, i) => {
      ...
      // значок стингера на левой границе части (звук играет при входе в неё)
...
function App() {
  ...
  const [stingerMenu, setStingerMenu] = useState(null); // индекс части с открытым меню стингера
  ...
  }), t.bass_swap_label)), deepAvailable && /*#__PURE__*/React.createElement("div", {
    className: "row",
    style: {
      marginTop: 10,
