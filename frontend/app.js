...
class LoopPlayer {
  ...
  _scheduleChunkRange(from, to, when, fadeIn = null, fadeOut = null, opts = {}) {
    ...
    const started = [];
    if (this.stems) {
      // multi-stem: each layer via its own gain (intensity)
...
function App() {
  ...
  // track change -> old track's stems are stale
  useEffect(() => {
    player.stems = null;
  ...
  const loadStems = async () => {
    ...
    try {
      ...
      player.stems = bufs;
      player.stemGains = null; // recreate with the current intensity
      setStemsState('ready');
  ...
  }), t.bass_swap_label)), (deepAvailable || songformerAvailable) && /*#__PURE__*/React.createElement("div", {
    className: "row",
    style: {
      marginTop: 10,
